...
namespace Sando.IntegrationTests
{
    ...
    /// </summary>
    public interface IProgressCallback : IInvoker
    {
        /// <summary>
        ...
        void Invoke(global::System.Windows.Forms.MethodInvoker globalSystemWindowsFormsMethodInvoker);

        void ShowDialog();

        void Close();

        void Invoke(System.Windows.Forms.MethodInvoker methodInvoker, bool forceUi);
    }
}
